...
func main() {
  ...
  list = append(list, LeafContent{content: "Hello"})
  list = append(list, LeafContent{content: "Hi"})
  list = append(list, LeafContent{content: "Hey"})
  list = append(list, LeafContent{content: "Hola"})
